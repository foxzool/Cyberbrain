...
module Cyberbrain
  describe AccessToken do
    ...
    describe '#same_credential?' do
      ...
      context 'with default parameters' do
        ...
        context 'the second token has different owner and same app' do
          let(:access_token2) { FactoryGirl.create :access_token, application: application }
    ...
    describe '.revoke_all_for' do
      let(:resource_owner) { double(id: SecureRandom.uuid) }
      let(:application) { FactoryGirl.create :application }
      let(:default_attributes) do
    ...
    describe '.matching_token_for' do
      let(:resource_owner_id) { SecureRandom.uuid }
      let(:application) { FactoryGirl.create :application }
